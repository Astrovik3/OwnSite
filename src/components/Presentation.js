    ...
    <Grid className="first">
      ...
      <Grid className="firstSub2">
        <p className="firstTextMenu"> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.  
          <text className="firstAbout"> about</text> mauris cursus mattis molestie a iaculis at. Urna neque viverra justo nec ultrices. Ultrices dui sapien eget mi. 
          ...
          Leo in vitae turpis massa <text className="firstAbout"> technologies</text> sed tempus. Nisl nisi scelerisque eu ultrices. Risus at ultrices mi tempus imperdiet. 
          Orci eu lobortis elementum nibh tellus molestie nunc. Eleifend quam adipiscing vitae proin sagittis <text className="firstAbout"> projects</text> rhoncus. 
          ...
          Et <text className="firstAbout"> contact</text> ac feugiat sed lectus vestibulum mattis. Augue lacus viverra vitae congue eu consequat. 
